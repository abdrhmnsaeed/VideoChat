        ...
        continueAndNextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent"))
                {
                    ...
                    {
                        Toast.makeText(RegistrationActivity.this, "Please write your verification code first", Toast.LENGTH_LONG).show();
                    }
                    else
                    {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Congratulations, You are Logged in successfully", Toast.LENGTH_LONG).show();
