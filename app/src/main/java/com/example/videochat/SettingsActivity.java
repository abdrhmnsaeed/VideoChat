...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void saveUserData() {
        ...
        if(imageUri == null)
        {
            ...
            Toast.makeText(this,"Status is Mandatory", Toast.LENGTH_LONG).show();
        }else{
                        ...
                        userRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).updateChildren(profileMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(SettingsActivity.this, "Profile Settings has been updated Successfully", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    }
